...
using Asciis.App.Tests.DependencyInjectionTests.PlatformTestSuite;
using Asciis.App.Tests.DependencyInjectionTests.TestData;
using Asciis.App.Tests.DependencyInjectionTests.TestData.NestedInterfaceDependencies;
using Xunit;
...
public class DICFunctionalTests
{
    ...
    public void NestedInterfaceDependencies_MissingIService3Registration_ThrowsExceptionWithDefaultSettings()
    {
        ...
        //Assert.IsType<>(result, typeof(NestedInterfaceDependencies.RootClass));
    }
    ...
    {
        var container = UtilityMethods.GetContainer();
        container.Register<TestData.NestedClassDependencies.Service1>();
        container.Register<TestData.NestedClassDependencies.Service2>();
        container.Register<TestData.NestedClassDependencies.Service3>();
        container.Register<TestData.NestedClassDependencies.RootClass>();

        var result = container.Resolve<TestData.NestedClassDependencies.RootClass>();

        Assert.IsType<TestData.NestedClassDependencies.RootClass>(result);
    }
    ...
    {
        var container       = UtilityMethods.GetContainer();
        var registerOptions = container.Register<TestData.NestedClassDependencies.RootClass>();
    ...
    public void NestedClassDependencies_MissingService3Registration_ResolvesRootResolutionOn()
    {
        ...
        var result = container.Resolve<TestData.NestedClassDependencies.RootClass>(new ResolveOptions() { UnregisteredResolutionAction = UnregisteredResolutionActions.AttemptResolve });
    ...
    public void NestedClassDependencies_MissingService3RegistrationAndUnRegisteredResolutionOff_ThrowsException()
    {
        ...
        Assert.Throws<DICResolutionException>(() => container.Resolve<TestData.NestedClassDependencies.RootClass>(new ResolveOptions() { UnregisteredResolutionAction = UnregisteredResolutionActions.Fail }));
    ...
    public void When_Unable_To_Resolve_Nested_Dependency_Should_Include_That_Type_In_The_Exception()
    {
        ...
        Assert.NotNull(e);
        Assert.Contains("NestedInterfaceDependencies.IService3", e?.ToString());
    }
    ...
    public void When_Unable_To_Resolve_Non_Nested_Dependency_Should_Include_That_Type_In_The_Exception()
    {
        ...
        Assert.NotNull(e);
        Assert.Contains("NestedInterfaceDependencies.IService1", e?.ToString());
    }
    ...
    public void Run_Platform_Tests()
    {
        ...
        Assert.Equal(0, failed);//, logger.Log);
    }
