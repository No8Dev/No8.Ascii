...
public class VecF
{
    ...
    public static VecF operator +(VecF left, float other) { return new VecF(left.X + other, left.Y + other); }
    public static VecF operator +(VecF left, VecInt other) { return new VecF(left.X + other.X, left.Y + other.Y); }
    ...
    public static bool operator >(VecF left, VecInt other) { return left.LengthSquared > other.LengthSquared; }
