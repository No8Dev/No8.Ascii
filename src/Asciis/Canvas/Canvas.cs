...
public class Canvas
{
    ...
    public float CircleCompensateRatio { get; set; } = 0.7f;
    ...
    public void DrawCircle(int xc, int yc, int r, Rune c, Color? foreground = null, Color? background = null)
    {
        ...
        {
            Draw(xc - x, yc - (int)(y*CircleCompensateRatio), c, foreground, background);   //upper left left
            Draw(xc - y, yc - (int)(x*CircleCompensateRatio), c, foreground, background);   //upper upper left
            Draw(xc + y, yc - (int)(x*CircleCompensateRatio), c, foreground, background);   //upper upper right
            Draw(xc + x, yc - (int)(y*CircleCompensateRatio), c, foreground, background);   //upper right right
            Draw(xc - x, yc + (int)(y*CircleCompensateRatio), c, foreground, background);   //lower left left
            Draw(xc - y, yc + (int)(x*CircleCompensateRatio), c, foreground, background);   //lower lower left
            Draw(xc + y, yc + (int)(x*CircleCompensateRatio), c, foreground, background);   //lower lower right
            Draw(xc + x, yc + (int)(y*CircleCompensateRatio), c, foreground, background);   //lower right right
            if (p < 0)
                p += 4 * x++ + 6;
            else
                p += 4 * (x++ - y--) + 10;
    ...
    public void FillCircle(int xc, int yc, int r, Rune c, Color? foreground = null, Color? background = null)
    {
        ...
        while (y >= x)
        {
            Drawline(xc - x, xc + x, yc - (int)(y*CircleCompensateRatio), c, foreground, background);
            Drawline(xc - y, xc + y, yc - (int)(x*CircleCompensateRatio), c, foreground, background);
            Drawline(xc - x, xc + x, yc + (int)(y*CircleCompensateRatio), c, foreground, background);
            Drawline(xc - y, xc + y, yc + (int)(x*CircleCompensateRatio), c, foreground, background);
            if (p < 0) p += 4 * x++ + 6;
            else p += 4 * (x++ - y--) + 10;
