...
public static class RuneExtensions
{
    ...
    /// </summary>
    private static readonly uint[,] Combining = 
        {
    ...
    public static int ColumnWidth(this Rune rune)
    {
        ...
        if (iRune is < 32 or >= 0x7f and <= 0xa0)
            return -1;
        if (iRune < 127)
            return 1;
        ...
        return 1 +
               (iRune >= 0x1100 &&
                (iRune <= 0x115f ||                    /* Hangul Jamo init. consonants */
                 iRune == 0x2329 || 
                 iRune == 0x232a ||                    /* Miscellaneous Technical */
                 iRune is >= 0x2e80 and <= 0xa4cf && iRune != 0x303f || /* CJK ... Yi */
                 iRune is >= 0xac00 and <= 0xd7a3 ||   /* Hangul Syllables */
                 iRune is >= 0xf900 and <= 0xfaff ||   /* CJK Compatibility Ideographs */
                 iRune is >= 0xfe10 and <= 0xfe19 ||   /* Vertical forms */
                 iRune is >= 0xfe30 and <= 0xfe6f ||   /* CJK Compatibility Forms */
                 iRune is >= 0xff00 and <= 0xff60 ||   /* Fullwidth Forms */
                 iRune is >= 0xffe0 and <= 0xffe6 ||   /* Alphabetic Presentation Forms*/
                 iRune is >= 0x1fa00 and <= 0x1facf || /* Chess Symbols*/
                 iRune is >= 0x20000 and <= 0x2fffd ||
                 iRune is >= 0x30000 and <= 0x3fffd)
                   ? 1
                   : 0);
    }
    ...
    /// </summary>
    public static int ConsoleWidth(this string str) => str.ToRuneArray().Sum(r => r.ColumnWidth());

    /// <summary>
    /// Gets the rune count of the string.
    /// </summary>
    /// <value>The rune count.</value>
    public static int RuneCount(this string str) => str.EnumerateRunes().ToArray().Length;
