...
https://ftp.zx.net.nz/pub/archive/ftp.kednos.com/pub/misc/vt-parser/vt-mouse.html
https://ftp.zx.net.nz/pub/archive/ftp.kednos.com/pub/misc/vt-parser/ek-vt520-rm.pdf
https://gist.github.com/halcyon/334da650816876d7be4d1bee8a157f25
...
public static class TerminalSeq
{
    ...
    public static class Control
    {
        ...
        public static string SoftReset => "\x1b[!p"; // CSI ! p   Soft terminal reset (DECSTR)
    ...
    public static class Color
    {
        ...
        public static string Back(System.Drawing.Color color) => $"\x1b[48;2;{color.R};{color.G};{color.B}m";
        ...
        public static string Underline(System.Drawing.Color color) => $"\x1b[58;2;{color.R};{color.G};{color.B}m";
    ...
    public static class VisualAttributes
    {
        ...
        ///         ISO-8613-3
        ///     48 ; 2 ; Pr ; Pg ; Pb           Background
        ///     48 ; 5 ; Ps                     Background
        ///     49 Default Background Color     Default Color Black
        /// 
        ///     90 foreground color to Black.
        ///     91 foreground color to Red.
        ///     92 foreground color to Green.
        ///     93 foreground color to Yellow.
        ///     94 foreground color to Blue.
        ///     95 foreground color to Magenta.
        ///     96 foreground color to Cyan.
        ///     97 foreground color to White.
        ///     100 background color to Black.
        ///     101 background color to Red.
        ///     102 background color to Green.
        ///     103 background color to Yellow.
        ///     104 background color to Blue.
        ///     105 background color to Magenta.
        ///     106 background color to Cyan.
        ///     107 background color to White.
        /// </param>
        public static string SelectGraphicRendition(int attr) => $"\x1b[{attr}m"; // CSI Ps m - SGR
    }
    ...
    public static class RectangleAreaProcessing
    {
        ...
        ///     27 Positive image
        /// </param>
        public static string ChangeAttributeInRectangle(int top, int left, int bottom, int right, params int[] psn1)
        {
            if (psn1 is null)
                return $"\x1b[{top};{left};{bottom};{right};0$r";

            var result = new StringBuilder( $"\x1b[{top};{left};{bottom};{right}" );
            foreach (var n in psn1)
            {
                result.Append(';');
                result.Append(n);
            }
    ...
    public static class TextProcessing
    {
        ...
        {
            public static string Set => "\x1b[?7h";
            public static string Clear => "\x1b[?7l"; 
        }
        ...
        ///     DECRLCM
        /// </summary>
        public static class RightToLeftCopy
        {
            public static string Set => "\x1b[?96h"; 
            public static string Clear => "\x1b[?96l";
        }
        ...
        ///     DECRLM
        /// </summary>
        public static class RightToLeftMode
        {
            public static string Set => "\x1b[?34h"; 
            public static string Clear => "\x1b[?34l";
        }
        ...
        ///     LNM
        /// </summary>
        public static class LineFeedNewLineMode
        {
            public static string NewLine => "\x1b[?20h"; 
            public static string LineFeed => "\x1b[?20l";
        }
        
        /// <summary>
        ///     Left Right Margin Modes
        ///     DECLRMM
        /// </summary>
        public static class LeftRightMarginMode
        {
            public static string Set => "\x1b[?69h"; 
            public static string Clear => "\x1b[?69l";
        }

        public static string SetLeftRightMargin(int leftCol, int rightCol) => $"\x1b[{leftCol};{rightCol}s";  // DECSLRM
        public static string SetTopBottomMargin(int top, int bottom) => $"\x1b[{top};{bottom}r";  // DECSTBM
        
        /// <summary>
        ///     Origin mode
        /// </summary>
        public static class OriginMode
        {
            public static string InMargins => "\x1b[?6h"; 
            public static string UpperLeft => "\x1b[?6l";
        }
        ...
        ///     DECSCLM
        /// </summary>
        public static class ScrollingMode
        {
            public static string Smooth => "\x1b[?4h"; 
            public static string Jump => "\x1b[?4l";
        }

        public static string SetScrollSpeed(int n) => $"\x1b]{n} p";  // DECSSCLS = 0 - 9 
        
        /// <summary>
        ///     Column Mode
        ///     DECCOLM
        /// </summary>
        public static class ColumnsMode
        {
            public static string Columns132 => "\x1b[?3h"; 
            public static string Columns80 => "\x1b[?3l";
        }
        ...
        ///     DECCOLM
        /// </summary>
        public static class ColumnModeChange
        {
            public static string NoClearScreen => "\x1b[?95h"; 
            public static string ClearScreen => "\x1b[?95l";
        }
    ...
    public static class KeyboardProcessing
    {
        ...
        ///     DECARM
        /// </summary>
        public static class Autorepeat
        {
            public static string Set => "\x1b[?8h";
            public static string Clear => "\x1b[?8l"; 
        }

        public static string SetAutorepeatRate(int rate) => $"\x1b[{rate}-p"; // DECARR - rate = 0 - 30
    }
    ...
    public static class Mode
    {
        ...
        /// </summary>
        public static string ScreenAlt => "\x1b[?1047h";
        public static string ScreenAltClear => "\x1b[?1049h";
        ...
        public static string MouseTrackingAnyEvent => "\x1b[?1003h";
        ...
        public static string MouseTrackingURX => "\x1b[?1015h";
        ...
        public static string StopMouseTrackingAnyEvent => "\x1b[?1003l";
        public static string StopMouseTrackingFocus => "\x1b[?1004l";
        public static string StopMouseTrackingUtf8 => "\x1b[?1005l";
        public static string StopMouseTrackingSGR => "\x1b[?1006l";
        public static string StopMouseTrackingURX => "\x1b[?1015l";
    }
    ...
    {
        public static string Set(int row, int col) => $"\x1b[{row};{col}H"; // CUP cursor position
        ...
        public static string MoveHorz(int n) => $"\x1b[{n}G";  // CHA Curshor horizontal absolute
        
        public static string TabBack(int n = 1) => n == 1 ? "\x1b[Z" : $"\x1b[{n}Z";  // CBT cursor backwards tabulation
        public static string TabForward(int n = 1) => n == 1 ? "\x1b[I" : $"\x1b[{n}I";  // CHT cursor forwards tabulation
        
        public static string NextLine(int n) => $"\x1b[{n}E";  // CNL Cursor next line
        public static string PrevLine(int n) => $"\x1b[{n}F";  // CPL Cursor next line

        public static string Show => "\x1b[?25h"; // DECTCEM
        public static string Hide => "\x1b[?25l"; // DECTCEM

        public static string InformationReport(string scs = "") => $"\x1bP1$u{scs}\x9C";  // DECCIR
        public static string PositionReport() => $"\x1b[6n";  // CPR cursor position report
        public static string PositionReportEx() => $"\x1b[?6n";  // DECXCPR extended cursor position report

        public static string SaveCursor => "\x1b7"; // DECSC
        public static string SaveCursorPosition => "\x1b[s"; // SCOSC
        public static string RestoreCursor => "\x1b8"; // DECRC
        public static string RestoreCursorPosition => "\x1b[u"; // SCORC
        ...
        {
            public static string Blinking => "\x1b[0 q";
            public static string Steady => "\x1b[2 q";
            public static string BlinkingUnderline => "\x1b[3 q";
            public static string SteadyUnderline => "\x1b[4 q";
            public static string BlinkingBar => "\x1b[5 q";
            public static string SteadyBar => "\x1b[6 q";
        }

        public static string SetHorzTab => "\x1bH"; // HTS
        public static string SetHorzTab8 => "\x1b]?5W"; // DECT8C
        public static string ClearHorzTab => "\x1b]0g"; // TBC
        public static string ClearAllHorzTab => "\x1b]3g"; // TBC
    }

    public static class Graphics
    {
        public static string Set(int n) => $"\x1b[{n}m";
    ...
    public static class Scroll
    {
        ...
        public static string Up(int count) => $"\x1b[{count}S";
        public static string Down(int count) => $"\x1b[{count}T";
    }
    ...
    public static class Device
    {
        ...
        public static string RequestTermInfoStringRaw(string Pt)
        {
    ...
    public static class ControlSeq
    {
        ...
        /// </summary>
        public static string CursorPosition(string row, string col) => $"\x1b[{row};{col}H"; // CSI Ps; Ps H    
        ...
        ///     Scroll down Ps lines(default => 1) (SD), VT420.
        /// </param>
        public static string ScrollDown(string Ps) => $"\x1b[{Ps}T"; // CSI Ps T    
        ...
        ///     Ps => 1002  ⇒  Use Cell Motion Mouse Tracking, xterm.See the section Button-event tracking. (Drag)
        ...
        /// </param>
        public static string PrivateModeSetDec(params int[] Ps)
        {
            if (Ps is null || !Ps.Any())
                return $"\x1b[?h";;
            if (Ps.Length == 1)
                return $"\x1b[?{Ps[0]}h";
        ...
        /// </param>
        public static string PrivateResetDec(params int[] Ps)
        {
            if (Ps is null || !Ps.Any())
                return "\x1b[?l";
            
            return $"\x1b[?{ string.Join(',',Ps) }l";
            // CSI ? Ps l
        }
        ...
        /// </param>
        public static string SetResourceValue(int Ps) => $"\x1b[>{Ps}p"; // CSI > Ps p
        ...
        public static string
            SaveCursor =
                "\x1b[s"; // CSI s     Save cursor, available only when DECLRMM is disabled (SCOSC, also ANSI.SYS).
        ...
        /// </summary>
        public static string EnableFilterRectangle(int top, int left, int bottom, int right)
        {
        ...
        /// </param>
        /// <returns></returns>
        public static string SelectLocatorEvents(params int[] Pm)
        {
            if (Pm is null || !Pm.Any())
                return $"\x1b[0'{{";
            
            return $"\x1b[{ string.Join(',',Pm) }'{{";
