...
public class TimeField : TextField
{
    ...
    private int longFieldLen = 8;
    private int shortFieldLen = 5;
    ...
    /// </remarks>
    /// <remarks>
    ///   The passed <see cref="System.EventArgs"/> is a <see cref="DateTimeEventArgs{T}"/> containing the old value, new value, and format string.
    /// </remarks>
    ...
    private void TextField_TextChanged(string e)
    {
        try
        {
    ...
    public virtual void OnTimeChanged(DateTimeEventArgs<TimeSpan> args) { TimeChanged?.Invoke(args); }
}
