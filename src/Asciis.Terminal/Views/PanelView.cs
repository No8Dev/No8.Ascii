...
{
    private ChildContentView childContentView;
    ...
    public PanelView(View child)
    {
        ...
        CanFocus = false;
        Child = child;
        if (child != null) Visible = child.Visible;
    }
    ...
    { 
        get => child != null && base.Visible;
        set
        {
            if (child == null)
            {
                visible = false;        // Skip redraw logic
                return;
            }
            base.Visible = value;
        } 
    ...
    private void Child_Initialized(object sender, System.EventArgs e)
    {
    ...
    private void Border_BorderChanged(Border obj) { AdjustContainer(); }
