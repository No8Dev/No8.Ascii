...
/// <remarks>
///   <para>
///     Creates a instance of <see cref="Core.MainLoop"/> to process input events, handle timers and
...
///     invoked on each iteration of the <see cref="Core.MainLoop"/>.
///   </para>
///   <para>
...
//    /// <summary>
//    /// The current <see cref="Window"/> object. This is updated when <see cref="Application.Run(Func{Exception, bool})"/> enters and leaves to point to the current <see cref="Window"/> .
//    /// </summary>
...
//        get
//        {
//            if (Driver == null) throw new ArgumentNullException("The driver must be initialized first.");
...
//    /// <summary>
//    /// Used only by <see cref="SystemConsoleDriver"/> to forcing always moving the cursor position when writing to the screen.
//    /// </summary>
...
//    public static Rectangle MakeCenteredRect(Size size)
//    {
//        return new Rectangle(new Point((Driver.Cols - size.Width) / 2, (Driver.Rows - size.Height) / 2), size);
//    }
...
//    /// </para>
//    /// <para>
//    /// Creates a <see cref="Window"/> and assigns it to <see cref="Top"/>
//    /// </para>
//    /// </remarks>
//    public static void Init(ConsoleDriver? driver = null, IMainLoopDriver? mainLoopDriver = null)
//    {
//        Init(() => Window.Create(), driver, mainLoopDriver);
//    }
...
//        Func<Window> topLevelFactory,
//        ConsoleDriver? driver = null,
//        IMainLoopDriver? mainLoopDriver = null)
//    {
...
//            if (UseSystemConsole)
//            {
//                Driver = new SystemConsoleDriver();
//                mainLoopDriver = new SystemConsoleMainLoop(Driver);
//            }
...
//        public RunState(Window view) { Toplevel = view; }

//        internal Window Toplevel;
...
//    private static void ProcessKeyDownEvent(KeyEvent ke)
//    {
//        var chain = toplevels.ToList();
//        foreach (var topLevel in chain)
//        {
...
//    private static void ProcessKeyUpEvent(KeyEvent ke)
//    {
//        var chain = toplevels.ToList();
//        foreach (var topLevel in chain)
//        {
...
//    private static View? FindDeepestTop(Window start, int x, int y, out int resx, out int resy)
//    {
...
//    private static View? FindDeepestMdiView(View start, int x, int y, out int resx, out int resy)
//    {
...
//    private static View? lastMouseOwnerView;

//    private static void ProcessMouseEvent(MouseEvent me)
//    {
//        var view = FindDeepestView(Current, me.X, me.Y, out var rx, out var ry);
...
//            if (view != null && view != MdiTop && top != Current) MoveCurrent((Window)top);
//        }
...
//    private static bool MoveCurrent(Window top)
//    {
...
//    private static bool OutsideFrame(Point p, Rectangle r)
//    {
...
//    ///   undo these changes.
//    /// </remarks>
//    public static RunState Begin(Window toplevel)
//    {
//        if (toplevel == null)
...
//                if (dup == null) toplevels.Push(toplevel);
//            }
...
//        if (toplevel.IsMdiContainer) Top = toplevel;
...
//            toplevel.SetRelativeLayout(new Rectangle(0, 0, Driver.Cols, Driver.Rows));
//        toplevel.LayoutSubviews();
//        toplevel.PositionToplevels();
//        toplevel.WillPresent();
//        if (refreshDriver)
//        {
//            if (MdiTop != null) MdiTop.OnChildLoaded(toplevel);
//            toplevel.OnLoaded();
//            Redraw(toplevel);
...
//    /// </summary>
//    public static void Shutdown() { ResetState(); }
...
//                if (firstIteration) state.Toplevel.OnReady();
...
//                if (Driver.EnsureCursorVisibility()) state.Toplevel.SetNeedsDisplay();
//            }
//            else if (!wait)
//            {
//                return;
...
//                if (DebugDrawBounds) DrawBounds(state.Toplevel);
...
//    private static void EnsureModalAlwaysOnTop(Window toplevel)
//    {
//        if (!toplevel.Running || toplevel == Current || MdiTop == null || toplevels.Peek().Modal) return;
...
//    private static bool MdiChildNeedsDisplay()
//    {
//        if (MdiTop == null) return false;

//        foreach (var top in toplevels)
//            if (top != Current && top.Visible &&
//                (!top.NeedDisplay.IsEmpty || top.ChildNeedsDisplay || top.LayoutNeeded))
//            {
...
//    /// </summary>
//    public static void Run<T>(Func<Exception, bool> errorHandler = null) where T : Window, new()
//    {
//        if (_initialized && Driver != null)
//        {
//            var top = new T();
//            if (top.GetType().BaseType != typeof(Window))
...
//    ///   </para>
//    /// </remarks>
//    /// <param name="view">The <see cref="Window"/> to run modally.</param>
//    /// <param name="errorHandler">Handler for any unhandled exceptions (resumes when returns true, rethrows when null).</param>
//    public static void Run(Window view, Func<Exception, bool> errorHandler = null)
//    {
//        var resume = true;
//        while (resume)
//        {
...
//    /// <summary>
//    /// Stops running the most recent <see cref="Window"/> or the <paramref name="top"/> if provided.
//    /// </summary>
...
//    ///   </para>
//    /// </remarks>
//    public static void RequestStop(Window top = null)
//    {
//        if (MdiTop == null || top == null || MdiTop == null && top != null) top = Current;
...
//            Current.Running = false;
//        }
//        else if (MdiTop != null && Current == top && MdiTop?.Running == true && Current?.Running == true &&
//                 top.Running
//                 && Current?.Modal == true && top.Modal)
//        {
...
//    private static void SetToplevelsSize(Rectangle full)
//    {
//        if (MdiTop == null)
//        {
//            foreach (var t in toplevels)
...
//    private static bool SetCurrentAsTop()
//    {
//        if (MdiTop == null && Current != Top && Current?.SuperView == null && Current?.Modal == false)
//        {
//            if (Current.Frame != new Rectangle(0, 0, Driver.Cols, Driver.Rows))
//                Current.Frame = new Rectangle(0, 0, Driver.Cols, Driver.Rows);
//            Top = Current;
//            return true;
//        }
...
//            {
//                toplevels.MoveNext();
//                while (toplevels.Peek() == MdiTop || !toplevels.Peek().Visible) toplevels.MoveNext();
//                Current = toplevels.Peek();
//            }
//    }
...
//    internal static bool ShowChild(Window top)
//    {
