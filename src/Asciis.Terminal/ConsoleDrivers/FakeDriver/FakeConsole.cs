...
public class FakeConsole
{
    ...
    private char[,] _buffer = new char[WIDTH, HEIGHT];
    ...
    public void MoveBufferArea(
        ...
        int targetTop,
        char sourceChar,
        ConsoleColor sourceForeground,
        ConsoleColor sourceBackground)
    {
        throw new NotImplementedException();
    }
    ...
    /// 
    /// </summary>
    public Stream OpenStandardError() { throw new NotImplementedException(); }
    ...
    /// 
    /// </summary>
    public Stream OpenStandardError(int bufferSize) { throw new NotImplementedException(); }
    ...
    /// 
    /// </summary>
    public Stream OpenStandardInput(int bufferSize) { throw new NotImplementedException(); }
    ...
    /// 
    /// </summary>
    public Stream OpenStandardInput() { throw new NotImplementedException(); }
    ...
    /// 
    /// </summary>
    public Stream OpenStandardOutput(int bufferSize) { throw new NotImplementedException(); }
    ...
    /// 
    /// </summary>
    public Stream OpenStandardOutput() { throw new NotImplementedException(); }
    ...
    /// 
    /// </summary>
    public Stack<ConsoleKeyInfo> MockKeyPresses = new();
    ...
    /// 
    /// </summary>
    public void SetError(TextWriter newError) { throw new NotImplementedException(); }
    ...
    /// 
    /// </summary>
    public void SetIn(TextReader newIn) { throw new NotImplementedException(); }
    ...
    public void SetOut(TextWriter newOut) { throw new NotImplementedException(); }
    ...
    public void SetWindowPosition(int left, int top) { throw new NotImplementedException(); }
    ...
    public void SetWindowSize(int width, int height) { throw new NotImplementedException(); }
    ...
    { 
        if (value is Rune rune)
            _buffer[CursorLeft, CursorTop] = (char)rune.Value;
        else
            throw new NotImplementedException(); 
    }
    ...
    public void Write(string format, object arg0, object arg1) { throw new NotImplementedException(); }
    ...
    /// <param name="format"></param>
    /// <param name="arg0"></param>
    public void Write(string format, object arg0) { throw new NotImplementedException(); }
    ...
    public void Write(string format, params object[] arg) { throw new NotImplementedException(); }
    ...
    /// </summary>
    /// <param name="value"></param>
    public void Write(char value) { _buffer[CursorLeft, CursorTop] = value; }
    ...
    /// <param name="format"></param>
    /// <param name="arg"></param>
    public void WriteLine(string format, params object[] arg) { throw new NotImplementedException(); }
