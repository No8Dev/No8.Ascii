...
public class OptionboxComposer : Composer<Optionbox, OptionboxLayout>
{
    public OptionboxComposer(Optionbox optionbox) : base(optionbox)
    {
    }
    ...
    public override void UpdateLayoutValues()
    {
        ...
        var checkedString = Control.CheckedString ?? "(o)";
        var uncheckedString = Control.UncheckedString ?? "( )";

        var checkedStr = Control.Checked == null ? uncheckedString :
        ...
        {
            var minTextLen = Max(checkedString.Length, uncheckedString.Length);
