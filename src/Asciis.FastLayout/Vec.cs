...
public class Vec
{
    ...
    public static readonly Vec Unknown = new(int.MinValue, int.MinValue);
    ...
    /// <summary>
    /// The eight vectors surrounding this one to the north, south, east, and west and points in between.
    /// </summary>
    ...
    /// <summary>
    /// The four vectors surrounding this one to the north, south, east, and west. 
    /// </summary>
    ...
    /// <summary>
    /// The four vectors surrounding this one to the northeast, southeast, southwest, and northwest.
    /// </summary>
    ...
    public Vec Offset(int  x, int y) => new(X + x, Y + y);
    public Vec OffsetX(int x) => new(X + x, Y);
    public Vec OffsetY(int y) => new(X, Y + y);
