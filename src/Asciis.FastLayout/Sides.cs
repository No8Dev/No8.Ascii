...
public class Sides
{
    public static Sides Zero => new(Number.Zero);

    public static Sides Create(Number value) => new(value);
    ...
    /// </summary>
    public Sides(Number value) { _start = _top = _end = _bottom = _all = value; }

    public Sides(Number? start = null,
                  Number? top = null,
                  Number? end = null,
                  Number? bottom = null,
                  Number? horizontal = null,
                  ...
                  Number? all = null)
    {
        ...
        if (horizontal != null) _start = _end = horizontal;
    ...
    public Number this[Side side]
    {
        get
        {
            switch (side)
            {
                ...
                default:
                    throw new ArgumentException("Unknown side", nameof(side));
            }
        }
        set
        {
    ...
    public Number ComputedEdgeValue(Side side, Number? defaultValue = null)
    {
        ...
        if ((side == Side.Start || side == Side.End) && this[Side.Horizontal].HasValue)
